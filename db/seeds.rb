...
Mushroom.create(
    ...
    description: '
    This ectomycorrhizal species is most frequently found in deciduous forests with oak, chestnut or hazel, but Common Chanterelles also occur under conifers and occasionally on roadside verges beneath deciduous hedgerows. Chanterelles show a preference for acid soils.
    June to October - even into November in mild autumns - in Britain and Ireland; often from October right through to the following March in southern Europe.', 
...
Mushroom.create(
    ...
    description: '	
    On chalky soil under deciduous trees; occasionally with dwarf willow on calcareous dune slacks. It seems likely that at different phases in their development the underground mycelia of Morels may be able to behave either symbiotically with trees (in an ectomycorrhizal relationship) or as saprotrophs.
    March to early June in Britain and Ireland.', 
...
Mushroom.create(
    ...
    description: '	
    Chicken-of-the-Woods is saprobic, feeding on dead or dying hardwood timber, mainly oak, sweet chestnut, beech and occasionally cherry and willow. Surprisingly, this conspicuous bracket fungus also occurs on yew trees, which are of course conifers.
...
Mushroom.create(
    ...
    description: '
    In common with most Amanita species, and with all common amanitas that occur in Britain, Amanita muscaria is ectomycorrhizal. The Fly Agaric forms mycorrhizal associations with a range of hardwood and softwood trees, notably birches, pines and spruces.
    The remarkable picture on the left shows a Fly Agaric growing on seashore gravel - presumably mycorrhizal with the Sea Buckthorn shrub in the background. This picture was taken near Walmer in Kent, UK.
...
Mushroom.create(
    ...
    description: '
    Do not taste any part of this species: it is poisonous. Young specimens have a mild odour but old ones smell rather unpleasant. It is found on chalky soil beneath beech and oak trees.
